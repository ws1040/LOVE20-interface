...
export const LOVE20LaunchAbi = [
  ...
  {
    "type": "function",
    "name": "MIN_GOV_REWARD_MINTS_TO_LAUNCH",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "PARENT_TOKEN_FUNDRAISING_GOAL",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "childTokensByLauncherAtIndex",
    "inputs": [
      {
        "name": "parentTokenAddress",
        "type": "address",
  ...
  {
    "type": "function",
    "name": "childTokensByLauncherCount",
    "inputs": [
      {
        "name": "parentTokenAddress",
        "type": "address",
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "name": "firstParentTokenFundraisingGoal",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
      ...
      {
        "name": "numOfMintGovRewardPerLaunchToken",
        "type": "uint256",
        "internalType": "uint256"
      }
    ],
