...
export const LOVE20VoteAbi = [
  ...
  {
    "type": "function",
    "name": "votesNumByAccountByActionId",
    "inputs": [
      {
        "name": "",
        "type": "address",
  ...
  {
    "type": "function",
    "name": "votesNumsByAccountByActionIds",
    "inputs": [
      {
        "name": "tokenAddress",
        "type": "address",
